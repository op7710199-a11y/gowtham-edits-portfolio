...
interface Props { portfolio: PortfolioItem[]; onOpenProject: (id: string) => void; }
  ...
  return (
    <section id="featured" className="section-padding relative">
      ...
      <div className="container-mx">
        <SectionHeading eyebrow="Featured Work" title={<>Films that <span className="text-gradient-gold">move people</span></>}
        ...
        <RevealScope className="mt-14 grid gap-5 md:grid-cols-2">
          {featured.map((p, i) => (
            <Reveal key={p.id ?? i} delay={i * 100} as="article">
